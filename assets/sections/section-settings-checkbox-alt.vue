              ...
              <div id="preferences-form" class="row"> <!-- START preferences-form -->
                ...
                <fieldset id="pref-checkbox-container">
                  ...
                  <div class="checkbox-wrap">
                    ...
                    <div v-for="select in selectsArray" :key="select.id" class="selection">
                      <input :value="select.id" v-model="selected" :id="select.id" :sector="select.id" :class="select.class" :default="select.default" type="checkbox"><label :for="select.id" >{{ select.name }}</label>
                    </div>
