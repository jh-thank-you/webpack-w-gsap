<template>
  ...
  <div class="overlay"> <!-- START Modal -->
    ...
    <!--<div class="slideshow" v-html="modalData"></div>--> <!-- modal is the html data string created by the axios ajax get call made below - The v-html directive is used to send the html data into the dive via innerHTML -->
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // axios.get( 'src/assets/modals/' + this.imageSrc + '.vue' ).then(response => this.modalData = response.data); // send the html data string to the modalData definition in data above
