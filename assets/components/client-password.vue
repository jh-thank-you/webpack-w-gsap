<template>
  ...
  <div v-if="showPasswordModal" class='password-modal'>
    ...
    <form id='password-form' class='log-in-form'>
      ...
      <p><a id="client-cancel" @click="updateCornerNavClient(), showMessage = false, password = '', hideTab(), showPasswordModal = false" type='cancel' class='button expanded cancel-me'>Cancel</a></p>
      </router-link>
